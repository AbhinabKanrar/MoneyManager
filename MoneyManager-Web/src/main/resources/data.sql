...
CREATE TABLE IF NOT EXISTS mm.collection_details(
	...
	customer_id BIGINT,
	user_id BIGINT,
	requested_payement_amount numeric,
	actual_payement_amount numeric,
	...
	CONSTRAINT customer_payment_details_user_id_fk_ FOREIGN KEY (user_id) REFERENCES mm.user_auth_details (user_id)
);


--CREATE [ OR REPLACE ] TRIGGER mm.customer_to_collection_mapper
--AFTER INSERT
--   ON mm.customer_details
--   FOR EACH ROW
--DECLARE
--
--BEGIN
